    ...
    <div class="wrapper">
        <div class="sidebar">
            <div class="sidebar-content">
                ...
                <p class="sidebar-text">Take control of your money. Track expenses, analyze spending, and reach your financial goals effortlessly.</p>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div style="text-align: right; margin-top: 10px;">
                                <a href="{{ route('password.request') }}" style="color: var(--orange); font-weight: 600; text-decoration: none;">Forgot password?</a>
                            </div>
                        </div>
                        <div class="remember">
                            <input type="checkbox" name="remember" id="remember" checked>
                            <label for="remember">Keep me signed in for 365 days</label>
                        </div>
