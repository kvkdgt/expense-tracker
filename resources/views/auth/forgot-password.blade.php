    ...
    <div class="wrapper">
        <div class="sidebar">
            <div class="sidebar-content">
                ...
                <p class="sidebar-text">We’ll help you get back in. Request a secure reset link and you’ll be tracking again within seconds.</p>
            </div>
        </div>
        ...
        <div class="main">
            <div class="container">
                <div class="header">
                    <h1>Reset access</h1>
                    <p>Enter your email and we’ll send you the magic link.</p>
                </div>
